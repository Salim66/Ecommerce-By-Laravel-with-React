						...
						<div class="card">
							<div class="card-body">
								<div class="border p-4 rounded">
                                    ...
                                    @error('email')
                                        <div class="alert alert-danger border-0 bg-danger alert-dismissible show fade">
										...
										<form class="row g-3" action="{{ route('login') }}" method="POST">
											...
											<div class="col-12">
												...
												<div class="input-group" id="show_hide_password">
													<input type="password" class="form-control border-end-0" id="inputChoosePassword" placeholder="Enter Password" name="password" required autocomplete="current-password">
												</div>
											</div>
											<div class="col-md-6">
