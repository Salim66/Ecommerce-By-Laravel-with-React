    ...
    <ul class="metismenu" id="menu">
        ...
        <li>
            ...
            <ul>
                ...
                <li> <a href="{{ route('processing.orders') }}"><i class="bx bx-right-arrow-alt"></i>Processing Order</a>
                </li>
                <li> <a href="{{ route('complete.orders') }}"><i class="bx bx-right-arrow-alt"></i>Complete Order</a>
                </li>
            </ul>
        </li>
    </ul>
